...
var file_signingEvent_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x32, 0x88,
...
var file_signingEvent_proto_depIdxs = []int32{
	...
	2, // 6: SigningService.SignTxn:output_type -> SignatureResponse
	3, // 7: SigningService.BatchSignTxn:output_type -> BatchSignatureResponse
	5, // 8: SigningService.GenerateNewKey:output_type -> KeyManagementResponse
	5, // 9: SigningService.DeleteKey:output_type -> KeyManagementResponse
