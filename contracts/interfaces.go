...
type ContractTransactionHandler interface {
	...
	BuildTransaction(ctx context.Context, senderInHash bool, msgSender, functionName string, arguments [][]byte, value float32, contract *storage.Contract) (*storage.Token, error)
